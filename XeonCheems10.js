...
if(time2 < "23:59:00"){
var xeonytimewisher = `Malam Lord`
 }
 if(time2 < "19:00:00"){
var xeonytimewisher = `Malam Lord`
 }
...
var xeonytimewisher = `Malam Lord`
 ...
 if(time2 < "15:00:00"){
var xeonytimewisher = `Sore Lord`
 }
 if(time2 < "11:00:00"){
var xeonytimewisher = `Pagi Lord`
 }
 if(time2 < "05:00:00"){
var xeonytimewisher = `Pagi Lord`
 } 
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://telegra.ph/file/c34b7cddd5c356600dab0.jpg',
                                sourceUrl: wagc,
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
	...
	if (!XeonTheCreator) return XeonStickOwner()
            ...
            if (text.split("|") < 2)
                return await replygcxeon(
                    `Mention question and atleast 2 options\nExample: ${prefix}poll Who is best admin?|Xeon,dycal,Doge...`
                )
            let options = []
...
let me = m.sender
let teks = `*「  Download Script 」*\n\nScript:\nhttps://www.mediafire.com/file/o32q2xa07etyy5i/SCRIPT+DYCAL+NO+ENC.7z/file\n\nSubscribe: Dycal Luxetich🫂`
...
break
  case 'totalfeature':
        ...
        break
            ...
            let me = m.sender
            let xmenu_oh = `*${xeonytimewisher} ${pushname} 👋*
*ꜱᴀʏᴀ ᴅʏᴄᴀʟ, ᴀᴋᴀɴ ᴍᴇᴍʙᴀɴᴛᴜ ᴀɴᴅᴀ ᴍᴇᴍᴘᴇʀᴍᴜᴅᴀʜ ᴘᴇᴋᴇʀᴊᴀᴀɴ ᴀɴᴅᴀ*
...
┌ 卍 *ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ*
│  ☌ *ɴᴀᴍᴀ* : ${botname}
│  ☌ *ᴅᴀꜰᴛᴀʀ ᴜꜱᴇʀ* : ${Object.keys(global.db.data.users).length}
│  ☌ *ʜᴏsᴛ ɴᴀᴍᴇ* : ɴᴀsᴀ
│  ☌ *ᴘʀᴇғɪx* : [ ${xprefix} ]
│  ☌ *ᴛᴏᴛᴀʟ ᴄʜᴀᴛ* : ${Object.keys(global.db.data.chats).length}
│  ☌ *ᴛᴏᴛᴀʟ ʜɪᴛ* : ${global.db.data.settings[botNumber].totalhit}
│  ☌ *ᴅᴀᴛᴇ* : ${xdate}
└——
┌ ㊣ *ᴄᴀᴛᴇɢᴏʀʏ ʟɪꜱᴛ*
│ ⑀ ${xprefix}ᴀʟʟᴍᴇɴᴜ
...
│ ⑀ ${xprefix}ᴏᴛʜᴇʀᴍᴇɴᴜ
└——
*✆ ᴊɪᴋᴀ ᴍᴇɴᴇᴍᴜᴋᴀɴ ʙᴜɢ ꜱᴇɢᴇʀᴀ ʜᴜʙᴜɴɢɪ ᴏᴡɴᴇʀ*`
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
...
case 'out': case 'verif':{
if (!isPremium) return replyprem(mess.premium)
if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nExample ${prefix+command} 6285798131837`)
